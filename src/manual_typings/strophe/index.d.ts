// Type definitions for Strophe.js v1.4.4
 ...
 *
 *  Returns:
 *    @returns {Strophe.Builder} A new Strophe.Builder object.
 */
export function $build(name: string, attrs?: Record<string, string>): Strophe.Builder;
 ...
 *    @returns {Strophe.Builder} A new Strophe.Builder object.
 */
export function $msg(attrs?: Record<string, string>): Strophe.Builder;
 ...
 *    @returns {Strophe.Builder} A new Strophe.Builder object.
 */
export function $iq(attrs?: Record<string, string>): Strophe.Builder;
 ...
 *    @returns {Strophe.Builder} A new Strophe.Builder object.
 */
export function $pres(attrs?: Record<string, string>): Strophe.Builder;
...
export namespace Strophe {
     ...
     *
     *  Parameters:
     *    @param {Element} elem - The xml element to operate on in an Element object.
     ...
     *
     *  Parameters:
     *   @param {Element} el - A XMLElement in a DOM element.
     ...
     *
     *  Parameters:
     *    @param {Element} elem - A XMLElement as DOM element.
     *
     *  Returns:
     ...
     *
     *  Parameters:
     *    @param {Element} elem - A XMLElement as a DOM element.
     *
     *  Returns:
     ...
     *
     *  Parameters:
     *    @param {HTMLElement} elem - A HTMLElement.
     *
     *  Returns:
     *    @returns A new, copied DOM element tree.
     */
     ...
     *
     *  Parameters:
     *    @param {LogLevel} level - The log level of the log message.  This will
     ...
     *
     *  Parameters:
     *    @param {Element | Strophe.Builder | {tree: () => Element}} elem - A XMLElement as DOM element or a Strophe.Builder or an object
     ...
     *    @param {Object} prototypeObject - The plugin's prototype.
     */
    ...
    class Builder {
         ...
         *
         *  Parameters:
         *    @param {Record<string, string>} moreAttrs - The attributes to add/modify in object notation.
         *
         *  Returns:
         *    @returns The Strophe.Builder object.
         */
         ...
         *    @param {Record<string, string>} attrs - The attributes of the child in object notation.
    ...
    class Handler {
         ...
         *
         * Parameters:
         * @param {(stanza:Element) => boolean} handler handler function to run if the configured attributes for it match against the stanza
         * @param {string} ns namespace to match the incoming stanza against to find the right handler
         * @param {string} name tagName to match the incoming stanza against to find the right handler
         * @param {string} type type to match the incoming stanza against to find the right handler
         * @param {string} id id to match the incoming stanza against to find the right handler
         * @param {string} from from jid to match the incoming stanza against to find the right handler
    ...
    class TimedHandler {
         ...
         *      handler is called.
         *    @param {() => boolean} handler - The callback to run when the handler fires.  This
    ...
    interface ConnectionOptions {
         ...
         *      EXTERNAL    - 10
         */
        mechanisms?: Array<Strophe.SASLMechanism>;
        /**
    ...
    class Connection {
         ...
         *    @param {ConnectionOptions} options - A hash of configuration options
         *
         *  Returns:
         ...
         *    @param {(status: number) => unknown} callback - Function that will fire on Http error
         *
         *  Example:
         ...
         */
        addProtocolErrorHandler(protocol: string, status_code: number, callback: (status: number) => unknown)
         ...
         *    @param {(status: Status, condition: string, elem: Element) => unknown} callback - The connect callback function.
         ...
         */
        connect(jid?: string, pass?: string, callback?: (status: Status, condition: string, elem: Element) => unknown, wait?: number, hold?: number, route?: string, authcid?: string, disconnection_timeout?: number): void;
         ...
         */
        attach(jid: string, sid: string, rid: string, callback?: (status: Status, condition: string, elem: Element) => unknown, wait?: number, hold?: number, wind?: number): void;
         ...
         *    @param {(status: Status, condition: string, elem: Element) => unknown} callback - The connect callback function.
         *    @param {number} wait - The optional HTTPBIND wait value.
         ...
         *    @param {number} hold - The optional HTTPBIND hold value.
         *      This is the number of connections the server will hold at one time.
         *      This should almost always be set to 1 (the default).
         *    @param {number} wind - The optional HTTBIND window value.
         *      This is the allowed range of request ids that are valid.
         *      The default is 5.
         */
        restore(jid?: string, callback?: (status: Status, condition: string, elem: Element) => unknown, wait?: number, hold?: number, route?: string): void;
         ...
         *
         *  Parameters:
         *    @param {Element} elem - T XMLElement ashe XML data received by the connection.
         */
         ...
         *
         *  Parameters:
         *    @param {Element} elem - T XMLElement ashe XMLdata sent by the connection.
         */
         ...
         *
         *  Parameters:
         *  @param {Element | Element[] | Strophe.Builder} elem - The stanza to send.
         */
         ...
         *    @param {(elem: Element)=> unknown} callback - The callback function for a successful request.
         *    @param {(elem: Element)=> unknown} errback - The callback function for a failed or timed
         *      out request.  On timeout, the stanza will be null.
         *    @param {number} timeout - The time specified in milliseconds for a
         *      timeout to occur.
         *
         *  Returns:
         *    @returns {string} The id used to send the presence.
         */
        sendPresence(elem: Element, callback: (elem: Element) => unknown, errback: (elem: Element) => unknown, timeout?: number): string;

        /** Function: sendIQ
         *  Helper function to send IQ stanzas.
         *
         *  Parameters:
         *    @param {Element} elem - T XMLElement ashe stanza to send.
         *    @param {(stanza: Element) => unknown} callback - The callback function for a successful request.
         *    @param {(stanza: Element) => unknown} errback - The callback function for a failed or timed
         *      out request.  On timeout, the stanza will be null.
         *    @param {number} timeout - The time specified in milliseconds for a
         *      timeout to occur.
         *
         *  Returns:
         *    @returns {string} The id used to send the IQ.
         */
         ...
         *    @param {() => boolean} handler - The callback function.
         *
         *  Returns:
         *    @returns {TimedHandler} A reference to the handler that can be used to remove it.
         */
         ...
         *
         *  Parameters:
         *    @param {(stanza: Element) => boolean} handler - The user callback.
         ...
         *
         *  Returns:
         *    @returns {Strophe.Handler} A reference to the handler that can be used to remove it.
         */
        addHandler(handler: (stanza: Element) => boolean, ns: string, name: string, type?: string | Array<string>, id?: string, from?: string, options?: { matchBareFromJid: boolean, ignoreNamespaceFragment: boolean }): Strophe.Handler;
         ...
         *
         *  Parameters:
         *    @param {Strophe.SASLMechanism[]} mechanisms - Array of objects with Strophe.SASLMechanism prototypes
         *
         */
         ...
         *
         *  Parameters:
         *    @param {new() => Strophe.SASLMechanism} Mechanism - Constructor for an object with a Strophe.SASLMechanism prototype
         *
         */
         ...
         *
         *  Parameters:
         *    @param {Strophe.SASLMechanism[]} mechanisms - Array of SASL mechanisms.
         *
         */
         ...
         *
         *  Parameters:
         *    @param {Strophe.SASLMechanism[]} matched - Array of SASL mechanisms supported.
         *
         */
