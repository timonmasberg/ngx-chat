...
const functions = {};
functions[FUNCTION.contactRequest] = null;
functions[FUNCTION.notificationRequest] = Notification.askForPermission;
functions[FUNCTION.multiUserInvitation] = null;
functions[FUNCTION.notification] = null;
functions[FUNCTION.unknownSender] = null;
