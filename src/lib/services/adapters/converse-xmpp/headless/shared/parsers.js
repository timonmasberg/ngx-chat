...
import { URL_PARSE_OPTIONS } from 'src/lib/services/adapters/converse-xmpp/headless/shared/constants.js';
import { _converse, api } from 'src/lib/services/adapters/converse-xmpp/headless/core';
import { decodeHTMLEntities } from 'src/lib/services/adapters/converse-xmpp/headless/utils/core.js';
import { rejectMessage } from 'src/lib/services/adapters/converse-xmpp/headless/shared/actions';
import {
    isAudioURL,
    isEncryptedFileURL,
    isImageURL,
    isVideoURL
} from 'src/lib/services/adapters/converse-xmpp/headless/utils/url.js';
