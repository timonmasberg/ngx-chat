...
import _converse from 'src/lib/services/adapters/converse-xmpp/headless/shared/_converse';
import advancedFormat from 'dayjs/plugin/advancedFormat';
import dayjs from 'dayjs';
import i18n from 'src/lib/services/adapters/converse-xmpp/headless/shared/i18n';
import invoke from 'lodash-es/invoke';
import isFunction from 'lodash-es/isFunction';
import log from 'src/lib/services/adapters/converse-xmpp/headless/log.js';
import pluggable from 'pluggable.js/src/pluggable.js';
import { settings_api, user_settings_api } from 'src/lib/services/adapters/converse-xmpp/headless/shared/settings/api.js';
import sizzle from 'sizzle';
import u, { setUnloadEvent, replacePromise } from 'src/lib/services/adapters/converse-xmpp/headless/utils/core.js';
import { Collection } from "@converse/skeletor/src/collection";
import { Connection, MockConnection } from 'src/lib/services/adapters/converse-xmpp/headless/shared/connection.js';
import { Events } from '@converse/skeletor/src/events.js';
import { Model } from '@converse/skeletor/src/model.js';
import { Strophe, $build, $iq, $msg, $pres } from 'strophe.js/src/strophe';
import { TimeoutError } from 'src/lib/services/adapters/converse-xmpp/headless/shared/errors';
import { getOpenPromise } from '@converse/openpromise';
import { html } from 'lit';
import { initAppSettings, } from 'src/lib/services/adapters/converse-xmpp/headless/shared/settings/utils.js';
